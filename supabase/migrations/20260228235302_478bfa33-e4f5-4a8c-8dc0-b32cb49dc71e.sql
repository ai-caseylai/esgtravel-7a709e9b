...
-- Seed 4 hardcoded events into posts table
INSERT INTO public.posts (slug, cover_image, is_published, category, event_date) VALUES
  ('kochi-eco-tour', 'https://jbfybrxpdippdsettdgv.supabase.co/storage/v1/object/public/media/event-kochi-eco.jpg', true, 'event', '2025-11-15'),
  ('sustainable-tourism-forum-2025', 'https://jbfybrxpdippdsettdgv.supabase.co/storage/v1/object/public/media/event-forum.jpg', true, 'event', '2025-09-20'),
  ('community-tree-planting', 'https://jbfybrxpdippdsettdgv.supabase.co/storage/v1/object/public/media/event-tree-planting.jpg', true, 'event', '2025-06-05'),
  ('marine-conservation-badge-launch', 'https://jbfybrxpdippdsettdgv.supabase.co/storage/v1/object/public/media/event-marine.jpg', true, 'event', '2025-03-22');

-- Kochi Eco Tour translations
INSERT INTO public.post_translations (post_id, lang, title, summary, content) VALUES
  ((SELECT id FROM posts WHERE slug='kochi-eco-tour'), 0, '高知縣生態旅遊體驗', '與當地社區合作，體驗高知縣的自然生態之美。參加者深入了解當地的可持續發展項目，並親身參與海岸清潔活動。', '高知縣位於日本四國島的南部，以其壯麗的自然風光和深厚的文化底蘊聞名。作為 STAR SDG 的旗艦合作地區之一，高知縣致力於將旅遊業與環境保護緊密結合。
...
活動結束後，參加者將獲頒數碼認證，記錄在個人旅遊護照中。我們相信，每一次負責任的旅行，都是為地球未來的一份投資。'),
  ((SELECT id FROM posts WHERE slug='kochi-eco-tour'), 1, '高知县生态旅游体验', '与当地社区合作，体验高知县的自然生态之美。参加者深入了解当地的可持续发展项目，并亲身参与海岸清洁活动。', '高知县位于日本四国岛的南部，以其壮丽的自然风光和深厚的文化底蕴闻名。作为 STAR SDG 的旗舰合作地区之一，高知县致力于将旅游业与环境保护紧密结合。
...
活动结束后，参加者将获颁数码认证，记录在个人旅游护照中。我们相信，每一次负责任的旅行，都是为地球未来的一份投资。'),
  ((SELECT id FROM posts WHERE slug='kochi-eco-tour'), 2, 'Kochi Eco-Tourism Experience', 'Partner with local communities to experience the natural beauty of Kochi Prefecture. Participants explore sustainable development projects and join coastal cleanup activities.', 'Kochi Prefecture, located on the southern coast of Shikoku Island, Japan, is renowned for its stunning natural landscapes and rich cultural heritage. As one of STAR SDG''s flagship partner regions, Kochi is committed to integrating tourism with environmental conservation.
...
After the event, participants receive a digital certificate recorded in their personal travel passport. We believe every responsible journey is an investment in our planet''s future.'),
  ((SELECT id FROM posts WHERE slug='kochi-eco-tour'), 3, '高知県エコツーリズム体験', '地域コミュニティと協力して高知県の自然の美しさを体験。参加者は持続可能な開発プロジェクトを探索し、海岸清掃活動に参加します。', '高知県は日本の四国島南部に位置し、壮大な自然景観と豊かな文化遺産で知られています。STAR SDGの旗艦パートナー地域の一つとして、高知県は観光と環境保護の融合に取り組んでいます。
...
-- Sustainable Tourism Forum translations
INSERT INTO public.post_translations (post_id, lang, title, summary, content) VALUES
  ((SELECT id FROM posts WHERE slug='sustainable-tourism-forum-2025'), 0, '永續旅遊論壇 2025', '匯集全球旅遊業領袖、環保專家及社區代表，探討如何通過創新科技和數碼工具推動旅遊業的永續發展。', '「永續旅遊論壇 2025」是 STAR SDG 年度最重要的旗艦活動，今年將在香港會議展覽中心舉行。論壇邀請了來自超過 30 個國家和地區的演講嘉賓，涵蓋政府官員、旅遊業巨頭、環保組織代表和科技創業者。
...
論壇期間還將發佈最新的「亞太區可持續旅遊指數報告」，為業界提供數據驅動的決策參考。所有與會者將獲得論壇限定版徽章。'),
  ((SELECT id FROM posts WHERE slug='sustainable-tourism-forum-2025'), 1, '可持续旅游论坛 2025', '汇集全球旅游业领袖、环保专家及社区代表，探讨如何通过创新科技和数码工具推动旅游业的可持续发展。', '「可持续旅游论坛 2025」是 STAR SDG 年度最重要的旗舰活动，今年将在香港会议展览中心举行。论坛邀请了来自超过 30 个国家和地区的演讲嘉宾，涵盖政府官员、旅游业巨头、环保组织代表和科技创业者。
...
During the forum, the latest "Asia-Pacific Sustainable Tourism Index Report" will be released, providing data-driven decision-making references for the industry. All attendees will receive a forum exclusive limited edition badge.'),
  ((SELECT id FROM posts WHERE slug='sustainable-tourism-forum-2025'), 3, '持続可能な観光フォーラム2025', '世界の観光リーダー、環境専門家、コミュニティ代表が集まり、イノベーションとデジタルツールが持続可能な観光をどう推進できるか探ります。', '「持続可能な観光フォーラム2025」は、STAR SDGの年間最重要フラッグシップイベントで、今年は香港コンベンション＆エキシビションセンターで開催されます。30以上の国と地域からスピーカーを招き、政府関係者、観光業界のリーダー、環境団体代表、テック起業家が参加します。
...
-- Community Tree Planting translations
INSERT INTO public.post_translations (post_id, lang, title, summary, content) VALUES
  ((SELECT id FROM posts WHERE slug='community-tree-planting'), 0, '社區植樹活動', '在當地社區舉辦植樹活動，與居民一起為環境保護出一分力。活動同時教育參加者關於碳中和和氣候變化的知識。', 'STAR SDG 的社區植樹活動已連續舉辦三年，足跡遍及亞洲多個城市和鄉村地區。今年的活動將在世界環境日（6月5日）當天同步於五個地點展開。
...
截至目前，STAR SDG 社區植樹活動已累計種植超過 15,000 棵樹木，參與人數超過 8,000 人次。'),
  ((SELECT id FROM posts WHERE slug='community-tree-planting'), 1, '社区植树活动', '在当地社区举办植树活动，与居民一起为环境保护出一分力。活动同时教育参加者关于碳中和和气候变化的知识。', 'STAR SDG 的社区植树活动已连续举办三年，足迹遍及亚洲多个城市和乡村地区。今年的活动将在世界环境日（6月5日）当天同步于五个地点展开。
...
截至目前，STAR SDG 社区植树活动已累计种植超过 15,000 棵树木，参与人数超过 8,000 人次。'),
  ((SELECT id FROM posts WHERE slug='community-tree-planting'), 2, 'Community Tree Planting', 'Organizing tree planting events in local communities, working with residents to contribute to environmental protection while educating participants about carbon neutrality and climate change.', 'STAR SDG''s Community Tree Planting event has been held for three consecutive years, with activities spanning multiple cities and rural areas across Asia. This year''s event will launch simultaneously at five locations on World Environment Day (June 5th).
...
To date, STAR SDG''s community tree planting events have planted over 15,000 trees, with more than 8,000 participants.'),
  ((SELECT id FROM posts WHERE slug='community-tree-planting'), 3, 'コミュニティ植樹活動', '地域コミュニティで植樹イベントを開催し、住民と共に環境保護に貢献。カーボンニュートラルと気候変動について参加者を教育します。', 'STAR SDGのコミュニティ植樹活動は3年連続で開催され、アジア各地の都市や農村地域に活動の足跡を残しています。今年は世界環境デー（6月5日）に5つの会場で同時開催されます。
...
-- Marine Conservation Badge Launch translations
INSERT INTO public.post_translations (post_id, lang, title, summary, content) VALUES
  ((SELECT id FROM posts WHERE slug='marine-conservation-badge-launch'), 0, '海洋保育徽章發佈', '正式發佈海洋保育主題徽章，與多個海洋保護組織合作，將徽章收入的 70% 用於支持珊瑚礁修復和海洋清潔項目。', '在世界水日（3月22日），STAR SDG 正式發佈全新的海洋保育主題徽章系列。這是我們與三個國際海洋保護組織——海洋守護者協會、珊瑚三角倡議組織和太平洋清潔聯盟——共同合作的成果。
...
發佈活動當天，我們在香港、東京、曼谷和雅加達四個城市同步舉行了海灘清潔活動，共有超過 2,000 名志願者參與，清理了超過 5 噸海洋垃圾。'),
  ((SELECT id FROM posts WHERE slug='marine-conservation-badge-launch'), 1, '海洋保育徽章发布', '正式发布海洋保育主题徽章，与多个海洋保护组织合作，将徽章收入的 70% 用于支持珊瑚礁修复和海洋清洁项目。', '在世界水日（3月22日），STAR SDG 正式发布全新的海洋保育主题徽章系列。这是我们与三个国际海洋保护组织——海洋守护者协会、珊瑚三角倡议组织和太平洋清洁联盟——共同合作的成果。
...
发布活动当天，我们在香港、东京、曼谷和雅加达四个城市同步举行了海滩清洁活动，共有超过 2,000 名志愿者参与，清理了超过 5 吨海洋垃圾。'),
  ((SELECT id FROM posts WHERE slug='marine-conservation-badge-launch'), 2, 'Marine Conservation Badge Launch', 'Official launch of marine conservation themed badges, partnering with ocean protection organisations. 70% of badge proceeds support coral reef restoration and ocean cleanup projects.', 'On World Water Day (March 22nd), STAR SDG officially launched a brand new marine conservation themed badge series. This is the result of our collaboration with three international ocean protection organizations — the Ocean Guardians Association, the Coral Triangle Initiative, and the Pacific Cleanup Alliance.
...
On the launch day, we held simultaneous beach cleanup events in four cities — Hong Kong, Tokyo, Bangkok, and Jakarta — with over 2,000 volunteers participating and clearing more than 5 tonnes of marine debris.'),
  ((SELECT id FROM posts WHERE slug='marine-conservation-badge-launch'), 3, '海洋保全バッジ発表', '海洋保全テーマのバッジを正式に発表。海洋保護団体と提携し、バッジ収益の70%をサンゴ礁修復と海洋清掃プロジェクトに充てます。', '世界水の日（3月22日）に、STAR SDGは海洋保全テーマの新しいバッジシリーズを正式に発表しました。これは3つの国際海洋保護団体——オーシャンガーディアンズ協会、コーラルトライアングルイニシアチブ、パシフィッククリーンアップアライアンス——との共同成果です。
