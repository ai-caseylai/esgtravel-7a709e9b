    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 pt-24 pb-32 relative">
          ...
          >
            ...
            <HtmlContent html={tc('site_hero_desc', '')} className="text-foreground/80 text-lg md:text-xl mb-8 leading-relaxed drop-shadow" />
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a href={tc('site_appstore_url', 'https://apps.apple.com')} target="_blank" rel="noopener noreferrer" className="bg-foreground text-background px-6 py-3 rounded-xl text-lg font-medium no-underline flex items-center justify-center gap-3 hover:opacity-90 transition-opacity shadow-lg">
                ...
                {tc('site_appstore_label', 'App Store')}
              </a>
              <a href={tc('site_googleplay_url', 'https://play.google.com')} target="_blank" rel="noopener noreferrer" className="bg-foreground text-background px-6 py-3 rounded-xl text-lg font-medium no-underline flex items-center justify-center gap-3 hover:opacity-90 transition-opacity shadow-lg">
                ...
                {tc('site_googleplay_label', 'Google Play')}
              </a>
            </div>
            <div className="mt-4">
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <HtmlContent html={tc('site_programme_desc', '')} className="text-muted-foreground text-lg max-w-2xl mx-auto" />
        </div>
          ...
          {features.map((f, i) => (
            ...
            >
              ...
              <div className="p-5 text-center">
                ...
                <HtmlContent html={f.desc} className="text-muted-foreground text-sm leading-relaxed" />
              </div>
            </motion.div>
          ))}
        </div>
      ...
      <section className="bg-muted/50 py-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <HtmlContent html={tc('site_sdg_desc', '')} className="text-muted-foreground text-lg" />
          </div>
      ...
      <section className="relative overflow-hidden py-20">
        ...
        <div className="max-w-6xl mx-auto px-4 text-center relative">
          ...
          <HtmlContent html={tc('site_cta_desc', '')} className="text-muted-foreground text-lg mb-6 max-w-xl mx-auto" />
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href={tc('site_appstore_url', 'https://apps.apple.com')} target="_blank" rel="noopener noreferrer" className="bg-foreground text-background px-6 py-3 rounded-xl text-lg font-medium no-underline flex items-center justify-center gap-3 hover:opacity-90 transition-opacity shadow-lg">
              <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>
              {tc('site_appstore_label', 'App Store')}
